...
BreastCancer_model = joblib.load('./models/BreastCancer_model.pkl')
HeartDisease_model = joblib.load('./models/HeartDisease_model.pkl')
Diabetes_model = joblib.load('./models/Diabetes_model.pkl')
ChronicDisease_model = joblib.load('./models/ChronicDisease_model.pkl')
# Home page
@app.route('/')
def home():
